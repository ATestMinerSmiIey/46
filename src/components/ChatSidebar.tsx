...
export function ChatSidebar() {
  ...
  return (
    <div className="fixed right-4 top-1/2 -translate-y-1/2 w-72 h-[575px] bg-card/90 backdrop-blur-md border border-border/50 rounded-xl flex flex-col z-40 shadow-xl">
